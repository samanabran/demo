# Changelog — SGC - Invoicing Dashboard

All notable changes to `sgc_invoicing_dashboard` are documented in this file.
...
- Run `odoo-bin --update=sgc_invoicing_dashboard --stop-after-init` after upgrading
