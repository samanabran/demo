# Changelog — SGC - Employee Appraisal

All notable changes to `sgc_appraisal` are documented in this file.
...
- Run `odoo-bin --update=sgc_appraisal --stop-after-init` after upgrading
