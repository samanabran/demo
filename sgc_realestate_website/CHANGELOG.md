# Changelog — SGC - Real Estate Website

All notable changes to `sgc_realestate_website` are documented in this file.
...
- Run `odoo-bin --update=sgc_realestate_website --stop-after-init` after upgrading
