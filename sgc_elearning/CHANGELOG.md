# Changelog — SGC - E-Learning

All notable changes to `sgc_elearning` are documented in this file.
...
- Run `odoo-bin --update=sgc_elearning --stop-after-init` after upgrading
